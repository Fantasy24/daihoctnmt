...
export default {
  ...
  methods: {
    ...
    async downloadFile(rowData) {
      const paramApi = { 
        url: `${API_AUTH}`+''.concat('/files/',rowData.id),
        method: 'GET'
       }
      await apiFactory
        .download(
