<template>
  <div class="wscn-http404-container">
    <div class="wscn-http404">
      ...
      <div class="bullshit">
        <div class="bullshit__oops">LỖI!</div>
        <div class="bullshit__headline">{{ message }}</div>
        <div class="bullshit__info">Kiểm tra lại đường dẫn. Hoặc quay lại trang chủ</div>
        <router-link :to="{ path: '/dashboard' }" class="bullshit__return-home">
          <em class="el-icon-back" /> Trang chủ
        </router-link>
      </div>
    </div>
  </div>
